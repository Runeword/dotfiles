...
const uint16_t PROGMEM thumb3_e[]    = {KC_ESC, KC_E, COMBO_END};
const uint16_t PROGMEM thumb3_c[]    = {KC_ESC, KC_C, COMBO_END};
const uint16_t PROGMEM thumb3_quot[] = {KC_ESC, KC_QUOT, COMBO_END};
const uint16_t PROGMEM thumb3_dot[]  = {KC_ESC, KC_DOT, COMBO_END};
const uint16_t PROGMEM thumb3_y[]    = {KC_ESC, KC_Y, COMBO_END};
const uint16_t PROGMEM thumb3_comm[] = {KC_ESC, KC_COMM, COMBO_END};
const uint16_t PROGMEM thumb3_p[]    = {KC_ESC, KC_P, COMBO_END};
const uint16_t PROGMEM thumb3_a[]    = {KC_ESC, KC_A, COMBO_END};
const uint16_t PROGMEM thumb3_o[]    = {KC_ESC, KC_O, COMBO_END};
const uint16_t PROGMEM thumb3_u[]    = {KC_ESC, KC_U, COMBO_END};
const uint16_t PROGMEM thumb3_j[]    = {KC_ESC, KC_J, COMBO_END};
const uint16_t PROGMEM thumb3_x[]    = {KC_ESC, KC_X, COMBO_END};
const uint16_t PROGMEM thumb3_k[]    = {KC_ESC, KC_K, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_split_3x5_2(KC_HOME, KC_END, KC_PGDN, KC_PGUP, KC_INS, KC_NO, KC_MPRV, KC_MNXT, KC_MPLY, KC_MUTE,
        ...
        KC_WH_U, KC_NO, KC_NO, KC_BRIU, KC_BRID, KC_VOLU, KC_VOLD, KC_DEL, KC_TRNS, KC_TRNS, KC_TRNS),
